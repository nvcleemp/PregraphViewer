 ...
 * @author nvcleemp
 */
public class ExportToLatex extends AbstractAction {

    private final LatexExportFrame latexExportFrame = new LatexExportFrame();
    private EmbeddedPregraphListModel listModel;

    public ExportToLatex(EmbeddedPregraphListModel listModel) {
        super("Export to LaTeX");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                latexExportFrame.setText(EmbeddedPregraphLatexExport.export(listModel.getSelectedGraph(), includeNumbers));
