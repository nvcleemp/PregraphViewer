...
/**
 * Empty implementation of the interface <code>EmbeddedPregraphListener</code>.
 * @author nvcleemp
 */
public class EmbeddedPregraphAdapter implements EmbeddedPregraphListener{
